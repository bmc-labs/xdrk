...
///       measurement devices normally operate, where the measurement
///       subsystem would write a measurement to memory via direct memory
///       access at a given frequency, and the recording subsystem would write
///       the contents of that memory address to disk at a given frequency, and
///       whatever overlaps - such as intermittent failures of the measurement
///       subsystem - occurred would be written off under _limitations of the
